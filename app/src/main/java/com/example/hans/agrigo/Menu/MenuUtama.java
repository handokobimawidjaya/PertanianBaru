...
//            sharedPreferences = getSharedPreferences(Login.sh, Context.MODE_PRIVATE);
//
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        switch (menuItem.getItemId()){
            ...
            case R.id.account_menu:
                data.putString(AccountFragment.SP_EMAIL, email);
                data.putString(AccountFragment.SP_NAMA, name);
//                    data.putString(AccountFragment.KEY_ACTIVITY2, name2);
